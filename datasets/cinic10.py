...
class Cinic10LSetup(DatasetSetup):
    ...
    def set_datasets_for_ssl(self, file_path, n_labeled, party_num):
        ...
        train_labeled_idxs, train_unlabeled_idxs = train_val_split(base_dataset.targets,
                                                                   ...
                                                                   self.num_classes)
        train_labeled_dataset = CINIC10LLabeled(file_path, train_labeled_idxs, split='test', transform=transforms_)
        train_unlabeled_dataset = CINIC10LLabeled(file_path, train_unlabeled_idxs, split='train', transform=transforms_)
